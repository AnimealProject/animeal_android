...
import com.epmedu.animeal.common.component.GpsSettingsProvider.GpsSettingState
...
class IntentGpsSettingsProvider(@ApplicationContext private val context: Context) : GpsSettingsProvider {
