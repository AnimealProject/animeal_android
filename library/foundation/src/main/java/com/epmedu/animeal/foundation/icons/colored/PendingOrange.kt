...
val AnimealIcons.Colored.PendingOrange: ImageVector
    get() {
        if (_PendingOrange != null) {
            return _PendingOrange!!
        }
        _PendingOrange = ImageVector.Builder(
            name = "Colored.PendingOrange",
            defaultWidth = 14.dp,
            defaultHeight = 15.dp,
            viewportWidth = 14f,
            viewportHeight = 15f
...
private var _PendingOrange: ImageVector? = null
