...
val AnimealIcons.Colored.Outdated: ImageVector
    get() {
        if (_Outdated != null) {
            return _Outdated!!
        }
        _Outdated = ImageVector.Builder(
            name = "Colored.Outdated",
            defaultWidth = 14.dp,
            defaultHeight = 15.dp,
            viewportWidth = 14f,
            viewportHeight = 15f
            ...
            path(
                fill = SolidColor(Color(0xFF790C13)),
...
private var _Outdated: ImageVector? = null
