...
val AnimealIcons.Colored.PendingGrey: ImageVector
    get() {
        if (_PendingGrey != null) {
            return _PendingGrey!!
        }
        _PendingGrey = ImageVector.Builder(
            name = "Colored.PendingGrey",
            defaultWidth = 14.dp,
            defaultHeight = 15.dp,
            viewportWidth = 14f,
            viewportHeight = 15f
            ...
            path(
                fill = SolidColor(Color(0xFF898A8D)),
...
private var _PendingGrey: ImageVector? = null
