...
internal class FavouriteApiImpl(
    ...
    override fun subscribeToFavouriteCreations(): Flow<OnCreateFavourite> {
    ...
    override fun subscribeToFavouriteDeletions(): Flow<OnDeleteFavouriteSubscription.OnDeleteFavourite> {
        return awsAppSyncClient.subscribe(
    ...
    override suspend fun addFavourite(
        ...
        return awsAppSyncClient.performMutation(
            CreateFavouriteMutation(
                CreateFavouriteInput.builder().id(null).feedingPointId(feedingPointId)
                    .userId(userId).build(),
                null
            )
        )
    ...
    override suspend fun deleteFavourite(
        ...
        return awsAppSyncClient.performMutation(
            DeleteFavouriteMutation(
                DeleteFavouriteInput.builder().id(id).build(),
                null
            )
        )
    }
